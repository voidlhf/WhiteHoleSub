...
// @icon         https://www.google.com/s2/favicons?sz=64&domain=hdmoli.com
// @grant        none
// ==/UserScript==
...
(function () {
  ...
  setInterval(() => {
    try {
      document.querySelector("#cciframe").contentDocument.querySelector("div#player > iframe").contentWindow.dpclose();
    } catch (error) { }
  }, 100);
})();